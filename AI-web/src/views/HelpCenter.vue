            ...
            <el-collapse v-model="activeTutorial" accordion>
              <el-collapse-item title="如何开始使用系统" name="1">
                <div class="tutorial-content">
                  ...
                  <h4>第三步：浏览主要功能</h4>
                  <p>系统主要功能包括：寝室管理、成员管理、费用管理、账单管理、支付功能、统计分析等。您可以通过左侧导航菜单访问各个功能模块。</p>
              ...
              <el-collapse-item title="寝室管理功能使用指南" name="2">
                <div class="tutorial-content">
                  <h4>查看寝室信息</h4>
                  <p>在寝室管理模块中，您可以查看寝室的基本信息、成员列表、费用分摊情况等。</p>
                  
                  <h4>添加寝室费用</h4>
                  <p>点击"新增费用"按钮，填写相关信息（金额、类别、描述等），保存后即可添加新的寝室费用记录。</p>
                  
                  <h4>费用分摊</h4>
                  <p>系统支持自动分摊费用功能，您可以设置费用分摊规则，系统会自动计算每个成员应承担的金额。</p>
                </div>
              </el-collapse-item>
              
              <el-collapse-item title="账单管理操作说明" name="3">
                <div class="tutorial-content">
                  <h4>生成账单</h4>
                  <p>在账单管理页面，点击"生成账单"按钮，系统会根据已录入的费用记录自动生成账单。</p>
                  
                  <h4>账单状态</h4>
                  <p>账单有三种状态：待付款、已付款、已逾期。您可以在账单列表中查看所有账单的状态。</p>
                  
                  <h4>账单支付</h4>
                  <p>点击账单详情，可以查看账单明细并进行支付操作。支持多种支付方式。</p>
                </div>
              </el-collapse-item>
            </el-collapse>
          </div>
...
const faqItems = [
  ...
  },
  {
    id: '2',
    question: '数据如何备份？',
    answer: '系统会自动定期备份您的数据，您也可以手动导出重要数据。在"个人中心"-"偏好设置"中可以选择导出数据的格式和范围。建议每月至少手动备份一次重要数据。'
  },
  {
    id: '3',
    question: '如何添加寝室费用？',
    answer: '在"费用管理"页面点击"添加费用"按钮，填写费用基本信息（金额、类别、描述等），设置分摊规则后保存即可。系统会自动计算每个成员应承担的金额。'
  },
  {
    id: '4',
    question: '如何生成账单？',
    answer: '在"账单管理"页面点击"生成账单"按钮，系统会根据已录入的费用记录自动生成账单。您也可以设置定时生成规则，系统会自动按周期生成账单。'
  },
  {
    id: '5',
    question: '系统支持哪些支付方式？',
    answer: '系统支持多种支付方式：微信支付、支付宝支付、银行卡支付等。具体可用的支付方式以页面显示为准。'
  },
  {
    id: '6',
    question: '如何查看费用统计？',
    answer: '在"统计分析"页面可以查看详细的费用统计图表，包括支出趋势、分类统计、成员分摊等。支持按时间范围筛选和导出功能。'
  }
]
...
const showContactInfo = () => {
  ElMessage({
    message: '客服电话：400-123-4567\n客服邮箱：support@accountingsystem.com\n工作时间：周一至周五 9:00-18:00',
    type: 'info',
    duration: 5000,
    showClose: true
  })
