...
#### 17.11.1 获取系统性能监控数据
- **接口地址**：GET /api/admin/system-monitor/performance
- **功能描述**：获取系统性能监控数据
- **请求参数**：
  - `timeRange` (string, 可选): 时间范围(1h/24h/7d/30d)
  - `metrics` (array, 可选): 指定指标类型
- **响应数据结构**：
```json
{
  "success": true,
...
#### 17.11.2 获取数据库监控数据
- **接口地址**：GET /api/admin/system-monitor/database
- **功能描述**：获取数据库监控数据
- **请求参数**：
...
#### 17.11.3 获取应用监控数据
- **接口地址**：GET /api/admin/system-monitor/application
- **功能描述**：获取应用监控数据
- **请求参数**：
  - `timeRange` (string, 可选): 时间范围
- **响应数据结构**：
...
#### 17.11.4 获取告警规则列表
- **接口地址**：GET /api/admin/system-monitor/alerts
- **功能描述**：获取系统监控告警规则列表
- **请求参数**：
  - `page` (number, 可选): 页码
    ...
    "alerts": [
      {
        ...
        "status": "string, 状态",
        "description": "string, 描述",
        "notificationConfig": "object, 通知配置",
...
#### 17.11.5 创建告警规则
- **接口地址**：POST /api/admin/system-monitor/alerts
- **功能描述**：创建系统监控告警规则
- **请求参数**：
```json
{
  "ruleName": "string, 必填, 规则名称",
  "metricType": "string, 必填, 指标类型",
  "condition": "string, 必填, 告警条件",
  "threshold": "number, 必填, 阈值",
  "severity": "string, 必填, 严重级别",
  "description": "string, 可选, 描述",
  "notificationConfig": "object, 可选, 通知配置"
}
```
- **响应数据结构**：
```json
...
#### 17.11.6 获取告警历史记录
- **接口地址**：GET /api/admin/system-monitor/alert-history
- **功能描述**：获取系统监控告警历史记录
- **请求参数**：
  - `page` (number, 可选): 页码
  - `pageSize` (number, 可选): 每页数量
  - `severity` (string, 可选): 严重级别筛选
...
```json
{
  ...
  "data": {
    "alerts": [
      {
        "id": "number, 告警记录ID",
        "ruleId": "number, 告警规则ID",
        "ruleName": "string, 规则名称",
        "metricType": "string, 指标类型",
        "severity": "string, 严重级别",
        "alertValue": "number, 告警值",
        "threshold": "number, 阈值",
        "message": "string, 告警消息",
        "status": "string, 状态",
...
#### 17.11.7 获取系统资源使用趋势
- **接口地址**：GET /api/admin/system-monitor/trends
- **功能描述**：获取系统资源使用趋势数据
- **请求参数**：
  - `timeRange` (string, 可选): 时间范围
  - `metrics` (array, 可选): 指定指标类型
